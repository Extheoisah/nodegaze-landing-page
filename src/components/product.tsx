...
export default function Product() {
  return (
    <section
      id="product"
      className="scroll-mt-[120px] lg:scroll-mt-[10px] bg-[#FFFFFF] min-w-full"
    >
      <div className="container mx-auto max-w-[1440px] px-[20px] lg:px-[40px] mt-[50px]">
        <p className="text-[40px] lg:text-[72px] font-[500] lg:font-[600] text-[#101928]">
          The Product
        </p>
        ...
        <div className="mt-[40px] flex flex-col gap-[30px] lg:gap-[50px] lg:grid lg:grid-cols-2 lg:pl-[40px]">
